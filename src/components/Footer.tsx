...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    { name: "LINKEDIN", url: "https://www.linkedin.com/in/rohit-lahori-a11ab9215/", icon: <FiLinkedin /> },
    { name: "GITHUB", url: "https://github.com/Rohit-Lahori02", icon: <FiGithub /> },
    { name: "EMAIL", url: "mailto:rohitlahori12@gmail.com", icon: <FiMail /> },
  ];
  ...
  return (
    <footer className="bg-white dark:bg-black/60 text-black dark:text-white border-t border-black/10 dark:border-white/15 font-sans backdrop-blur-sm">
          ...
          <div>
            <Link to="/" onClick={scrollToTop} className="block group">
              <div className="flex items-center text-4xl sm:text-4xl md:text-3xl lg:text-4xl tracking-tighter">
                ...
                <span className="font-light ml-2 dark:text-white">LAHORI</span>
      ...
      <div className="border-t border-black/10 dark:border-white/10 py-6 px-6 md:px-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-[10px] md:text-xs font-mono uppercase text-gray-500 tracking-widest">
        <div>
          &copy; {new Date().getFullYear()} Rohit Lahori. All Rights Reserved.
        </div>
